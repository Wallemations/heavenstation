/obj/item/gun/ballistic/revolver/ocelot
	...
	desc = "A modified Peacemaker Revolver that chamber .357 ammo. Less powerful than the regular .357, but ricochets a lot more."
	/*We need tension...conflict. The world today has become too soft. We're living in an age where true feelings are suppressed.
	So we're going to shake things up a bit. We'll create a world dripping with tension... ...a world filled with greed and suspicion, bravery and cowardice.*/
