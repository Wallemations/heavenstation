...
/datum/outfit/armadyne_security
	...
	backpack_contents = list(/obj/item/melee/baton/security, /obj/item/storage/box/gunset/pdh_corpo, /obj/item/storage/box/handcuffs, /obj/item/ammo_box/magazine/dmr=2)
