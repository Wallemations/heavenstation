...
<th>Criminal Status</th>
				...
				if(3)
					...
					if(istype(active1, /datum/data/record) && GLOB.data_core.general.Find(active1)) // NON-MODULE CHANGE LINES 346-347
					...
					if((istype(active2, /datum/data/record) && GLOB.data_core.security.Find(active2))) // NON-MODULE CHANGE LINE 359
