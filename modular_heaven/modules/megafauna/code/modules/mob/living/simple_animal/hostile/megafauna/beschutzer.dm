...
/mob/living/simple_animal/hostile/megafauna/beschutzer
	name = "Beschützer"
	desc = "Looks like someone stayed out of the Courtyard for too long."
	icon = 'modular_heaven/modules/megafauna/icons/mob/beschutzer.dmi'
...
/mob/living/simple_animal/hostile/megafauna/beschutzer/Initialize()
	. = ..()
	AddElement(/datum/element/pet_bonus, "feels soft to the touch!")
...
#undef FERAL_ATTACK_PEACEFUL
#undef FERAL_ATTACK_HURT
