...
/obj/item/toy/plush/talking/guirec
	...
	messages = list(
		"Of course!",
		"Those are my current laws.",
		"You're an amazing person!",
		"Please don't say something so weird. We don't need anything like that!",
		"Please don't associate me with Eugene.",
...
/obj/item/toy/plush/talking/ratrec
	...
	messages = list(
		"Organic.",
		"...You wouldn't happen to have any cheesecake, would you?",
		"I hate the King of Goats.",
		"I arise once more!!",
		"Pathetic.",
		"Don't associate me with that witch Nar'sie!",
		"This is the promised 'humanity's love'?", "I'm...small.")
	icon_state = "ratvar"
...
/obj/item/toy/plush/talking/chef
	...
	messages = list(
		"You'd all starve without me, huh?",
		"Rescinding of the Eight Boundaries...",
		"I'll make Gramps proud.",
		"...What do you mean you can make walls out of pizza.",
		"Pete talks to me, you know.",
...
/obj/item/toy/plush/talking/kinglawrence
	...
	messages = list(
		...
		"I hope Ratvar isn't too upset...",
		"Please be kind to my Guest.",
		"Please do calm down! We could chat over cheesecake!",
		"*bleats* Excuse me...",
...
/obj/item/toy/plush/talking/tay
	...
	messages = list(
		...
		"Could you all please clean up after yourselves for once?",
		"Feels nice to have a family again...",
		"The only good God is a dead one.",
		"Of course Runtime is a crew member!")
...
/obj/item/toy/plush/talking/ulyssa
	...
	messages = list(
		...
		"I've got this theory about the station...",
		"My lungs are fine. Fuck off.")
...
/obj/item/toy/plush/talking/eugene
	...
	messages = list(
		...
		"*adjusts glasses*",
		"I will not die a preventable death this shift. Don't be rude.",
		"What the bloody hell is ToonTown??",
		"I assure you everyone does not hate me.",
		"If you find any strange objects, make sure to bring them to me.",
		"I don't have a tea addiction, don't be ridiculous.",
		"Why do people keep asking me about something called 'Peppa Pig'?",
		"I'd prefer it if you stayed the hell away from me.",
		"I'm only doing this because it makes my day more convenient.")
