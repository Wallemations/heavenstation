...
/mob/living
	...
	var/mob_speech_sounds = list('modular_heaven/modules/text_and_speech_change/sounds/speak_1.ogg' = 120, \
	...
	var/mob_radio_sounds = list('modular_heaven/modules/text_and_speech_change/sounds/radio.ogg' = 75, \
								'modular_heaven/modules/text_and_speech_change/sounds/radio_2.ogg' = 75)
